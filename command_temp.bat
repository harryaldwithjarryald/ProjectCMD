...
echo In order to bypass this limitation, move the file "booster_ProjectCMD.reg" found in the user folder (C:\users\[your username]), to the root directory of your C:\ drive.
